module.exports = {
    ...
    theme: {
        ...
        colors: {
            ...
            "text-base-primary": "var(--text-base-primary)",
            "text-base-600": "var(--text-base-600)",
            "text-base-500": "var(--text-base-500)",
            "text-base-400": "var(--text-base-400)",
            "text-accent-600": "var(--text-accent-600)",
            "text-accent-500": "var(--text-accent-500)",
            "text-accent-400": "var(--text-accent-400)",
            ...
            "text-contrast-primary": "var(--text-contrast-primary)",
        ...
        innerShadow: {
            ...
            2: 'inset 0px 2px 2px -1px var(--box-inner-shadow-color)',
            3: 'inset 0px 6px 3px -4px var(--box-inner-shadow-color)',
            4: 'inset 0px 8px 4px -2px var(--box-inner-shadow-color)',
        }
    },
    plugins: [
