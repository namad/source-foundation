...
module.exports = {
    ...
    theme: {
        extend: {
            ...
            spacing: {
                "xs4": "var(--spacing-primary-xs4)",
                "xs3": "var(--spacing-primary-xs3)",
                "xs2": "var(--spacing-primary-xs2)",
                "xs": "var(--spacing-primary-xs)",
                "sm": "var(--spacing-primary-sm)",
                "base": "var(--spacing-primary-base)",
                "md": "var(--spacing-primary-md)",
                "lg": "var(--spacing-primary-lg)",
                "xl": "var(--spacing-primary-xl)",
                "xl3": "var(--spacing-primary-xl3)",
                "xl2": "var(--spacing-primary-xl2)",
                "xl4": "var(--spacing-primary-xl4)",
                "xl5": "var(--spacing-primary-xl5)",

                "primary-xs4": "var(--spacing-primary-xs4)",
                "primary-xs3": "var(--spacing-primary-xs3)",
                "primary-xs2": "var(--spacing-primary-xs2)",
                "primary-xs": "var(--spacing-primary-xs)",
                "primary-sm": "var(--spacing-primary-sm)",
                "primary-base": "var(--spacing-primary-base)",
                "primary-md": "var(--spacing-primary-md)",
                "primary-lg": "var(--spacing-primary-lg)",
                "primary-xl": "var(--spacing-primary-xl)",
                "primary-xl3": "var(--spacing-primary-xl3)",
                "primary-xl2": "var(--spacing-primary-xl2)",
                "primary-xl4": "var(--spacing-primary-xl4)",
                "primary-xl5": "var(--spacing-primary-xl5)",

                "secondary-xs4": "var(--spacing-secondary-xs4)",
                "secondary-xs3": "var(--spacing-secondary-xs3)",
                "secondary-xs2": "var(--spacing-secondary-xs2)",
                "secondary-xs": "var(--spacing-secondary-xs)",
                "secondary-sm": "var(--spacing-secondary-sm)",
                "secondary-base": "var(--spacing-secondary-base)",
                "secondary-md": "var(--spacing-secondary-md)",
                "secondary-lg": "var(--spacing-secondary-lg)",
                "secondary-xl": "var(--spacing-secondary-xl)",
                "secondary-xl3": "var(--spacing-secondary-xl3)",
                "secondary-xl2": "var(--spacing-secondary-xl2)",
                "secondary-xl4": "var(--spacing-secondary-xl4)",
                "secondary-xl5": "var(--spacing-secondary-xl5)",
            }
        },
        boxShadow: {
            "sm": "var(--elevation-1)",
