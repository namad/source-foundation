...
function findVariableByName(variableName) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (variableName == "text/contrast/600")
            debugger;
...
/* harmony import */ var _color_generators_render_accents__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./color-generators/render-accents */ "./src/color-generators/render-accents.ts");
/* harmony import */ var _color_generators_accent_palette_generator__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./color-generators/accent-palette-generator */ "./src/color-generators/accent-palette-generator.ts");
...
figma.ui.onmessage = (eventData) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (eventData.type === "IMPORT") {
        yield (0,_import_tokens__WEBPACK_IMPORTED_MODULE_8__.initiateImport)(params);
        yield (0,_import_tokens__WEBPACK_IMPORTED_MODULE_8__.importAllTokens)(params);
    }
    else if (eventData.type === "EXPORT") {
        yield (0,_import_export_json__WEBPACK_IMPORTED_MODULE_7__.exportToJSON)(eventData.exportJSONParams, eventData.params);
        yield (0,_import_export_json__WEBPACK_IMPORTED_MODULE_7__.exportBrandVariantToJSON)(eventData.exportBrandParams, eventData.params);
    }
        ...
        yield (0,_import_export_json__WEBPACK_IMPORTED_MODULE_7__.importFromJSON)(eventData.data, eventData.params).catch(error => {
            console.error(error);
            figma.ui.postMessage("importCompleted");
        ...
        yield figma.loadFontAsync({ family: "Inter", style: "Regular" });
        const lightAccentTokens = (0,_color_generators_accent_palette_generator__WEBPACK_IMPORTED_MODULE_4__.generateGlobalAccentPalette)('light', params);
        const darkAccentTokens = (0,_color_generators_accent_palette_generator__WEBPACK_IMPORTED_MODULE_4__.generateGlobalAccentPalette)('dark', params);
        const frameLightPalette = (0,_color_generators_render_accents__WEBPACK_IMPORTED_MODULE_3__.renderAccents)(lightAccentTokens, 'Light Mode Accents');
        const frameDarkPalette = (0,_color_generators_render_accents__WEBPACK_IMPORTED_MODULE_3__.renderAccents)(darkAccentTokens, 'Dark Mode Accents');
        ...
        const store = yield _utils_figma_library_variables__WEBPACK_IMPORTED_MODULE_2__.getStoreData();
        ...
        try {
            ...
            savedPreset = JSON.parse(pluginData);
        }
        catch (e) {
            console.warn('failed to read plugin data', e);
        }
        savedPreset = savedPreset ? Object.assign(_defaults__WEBPACK_IMPORTED_MODULE_9__.defaultSettings, savedPreset) : null;
