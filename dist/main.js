...
(function() {
  ...
  const testContext = new TestContextManager();
  ...
  function nodeToObject(node, seen = /* @__PURE__ */ new WeakSet()) {
    var _a;
    ...
    try {
      ...
      switch (node.type) {
        ...
        case "COMPONENT_SET":
        case "INSTANCE":
          result.children = (_a = node.children) == null ? void 0 : _a.map((child) => nodeToObject(child, seen));
  ...
  class TestRegistry {
    constructor() {
      ...
      __publicField(this, "beforeEachHooks", []);
      __publicField(this, "afterEachHooks", []);
     ...
     * @private
     */
    executeBeforeEachHooks() {
      return __async(this, null, function* () {
        for (const hook of this.beforeEachHooks) {
          yield Promise.resolve(hook());
        }
      });
    }
    /**
    ...
    runTest(name, testFn, framework) {
      return __async(this, null, function* () {
        ...
        try {
          yield this.executeBeforeEachHooks();
          let returnValue;
          if (testFn) {
            const fn2 = new Function("context", "expect", `return (${testFn})(context, expect)`);
            returnValue = yield Promise.resolve(fn2(context, expectFn));
            returnValue = nodeToObject(returnValue);
          } else {
            returnValue = yield Promise.resolve(fn(context, expectFn));
          }
          yield new Promise((resolve) => setTimeout(resolve, 10));
          yield this.executeAfterEachHooks();
    ...
    try {
      switch (message.type) {
        case "REGISTER_TEST": {
          ...
          try {
            const testFn = (context, expect$1) => __async(this, null, function* () {
              try {
        ...
        case "RUN_TEST": {
          try {
            registry.runTest(message.data.testName, message.data.testFn, message.data.framework).then((result) => {
  ...
  const DEFAULT_WINDOW_SETTINGS = {
    dev: defaultSettings$1,
    preview: defaultPreviewSettings,
    build: defaultSettings$1,
    test: defaultSettings$1
  };
  ...
  const bezier = function(colors) {
    ...
    if (colors.length === 2) {
      ...
      I = function(t) {
        ...
        const lab3 = [0, 1, 2].map(
          (i) => labs.reduce(
            (sum, el, j) => sum + row[j] * __pow(u, n - j) * __pow(t, j) * el[i],
            0
          )
        );
        return new Color(lab3, "lab");
  ...
  function getStoreData(refresh = false) {
    return __async(this, null, function* () {
      ...
      yield Promise.all(libraryCollections.map((collection2) => __async(this, null, function* () {
        return yield figma.teamLibrary.getVariablesInLibraryCollectionAsync(collection2.key).then((data) => {
  ...
  function importLibraryVariables(libraryName) {
    return __async(this, null, function* () {
      ...
      if (importedVariablesLibrary.length == 0) {
        yield Promise.all(data.map((record) => __async(this, null, function* () {
  ...
  function getFigmaCollection(name) {
    return __async(this, null, function* () {
      let isNew = false;
      let collection2 = yield findFigmaVariableCollectionByName(name);
      if (!collection2) {
        isNew = true;
  ...
  function setFigmaVariable(_0, _1, _2, _3) {
    return __async(this, arguments, function* (collection2, modeId, type2, variableName, value = null, scopes = ["ALL_SCOPES"], description = null) {
      let figmaVariable = yield findFigmaVariableByName(variableName, collection2.name);
      if (!figmaVariable) {
        try {
  ...
  function getDefaultVariableValue(figmaVariable, modeId) {
    return __async(this, null, function* () {
      ...
      const collection2 = yield figma.variables.getVariableCollectionByIdAsync(collectionID);
  ...
  function findVariableByReferences(alias) {
    return __async(this, null, function* () {
      ...
      for (const reference of references || []) {
        ...
        const figmaVariable = yield findFigmaVariableByName(name);
        if (figmaVariable) {
  ...
  function getFontDetailsTokens() {
    return __async(this, null, function* () {
      ...
      const collection2 = yield findFigmaVariableCollectionByName(collectionName);
      let names = [];
      if (collection2 == null) {
  ...
  function updateMaskComponentLayers(shadowComponent, shadowToken) {
    return __async(this, null, function* () {
      ...
      while (shadowTokenValue.length) {
        ...
        const colorVariable = yield findVariableByReferences(effectValue.color);
  ...
  function importTextStyles(tokens2) {
    return __async(this, null, function* () {
      fontLoadStatus = [];
      for (const [name, token] of Object.entries(tokens2)) {
        ...
        try {
          ...
          const lineHeightVariable = typeof lineHeightValue == "string" ? yield findVariableByReferences(lineHeightValue) : null;
          const fontSizeValue = token.$value.fontSize;
          const fontSizeVariable = typeof fontSizeValue == "string" ? yield findVariableByReferences(fontSizeValue) : null;
          const paragraphSpacingValue = token.$value.paragraphSpacing;
          const paragraphSpacingVariable = typeof paragraphSpacingValue == "string" ? yield findVariableByReferences(paragraphSpacingValue) : null;
          const fontFamilyValue = token.$value.fontFamily;
          const fontFamilyVariable = typeof fontFamilyValue == "string" ? yield findVariableByReferences(fontFamilyValue) : null;
          const fontStyleValue = token.$value.fontStyle;
          const fontStyleVariable = typeof fontStyleValue == "string" ? yield findVariableByReferences(fontStyleValue) : null;
  ...
  function parseValues(value, dictionary) {
    return __async(this, null, function* () {
      ...
      for (const [key, tokenReference] of Object.entries(value)) {
        const resolvedVariable = yield findVariableByReferences(tokenReference);
        if (resolvedVariable) {
          output[key] = yield getDefaultVariableValue(resolvedVariable);
        } else {
  ...
  function getLocalStyles$1() {
    return __async(this, null, function* () {
      return yield figma.getLocalTextStylesAsync();
    });
  }
  function getStyleByName$1(name) {
    return __async(this, null, function* () {
      const stylesByType = yield getLocalStyles$1();
  ...
  function convertFigmaTextStyleToToken(style) {
    return __async(this, null, function* () {
      ...
      for (const prop in style.boundVariables) {
        ...
        typographyTokenValue[prop] = yield getAliasName(boundVariable.id);
      }
  ...
  function importEffectStyles(tokens2, dictionary) {
    return __async(this, null, function* () {
      if (dictionary) {
  ...
  function convertEffectStyleToFigma(value) {
    return __async(this, null, function* () {
      const {
        effectTokenValue,
        boundProps
      } = yield resolveBoundValues(value);
      let effect = {
  ...
  function resolveBoundValues(effectValue) {
    return __async(this, null, function* () {
      ...
      for (const prop in copy) {
        const figmaVariable = yield findVariableByReferences(copy[prop]);
        if (figmaVariable) {
          boundProps.push({
            propName: prop,
            variable: figmaVariable
          });
          const defaultValue = yield getDefaultVariableValue(figmaVariable);
  ...
  function convertFigmaShadowEffectToToken(effect, colorFormat) {
    return __async(this, null, function* () {
      ...
      for (const prop in effect.boundVariables) {
        ...
        effectTokenValue[prop] = yield getAliasName(boundVariable.id);
      }
  ...
  function getCollectionAndPrepareTokens(_0) {
    return __async(this, arguments, function* ({ collectionName, modeName, modeIndex = -1, data, sortFn = null, isSingleMode = false }) {
      let modeId;
      const { collection: collection2, isNew } = yield getFigmaCollection(collectionName);
      ...
      if (isNew) {
        for (const token of transformedTokens) {
          ...
          yield setFigmaVariable(collection2, modeId, type2, token.name);
        }
      }
      return {
  ...
  function importVariables(_0) {
    return __async(this, arguments, function* ({ collectionName, modeName, modeIndex = -1, data, sortFn = null, isSingleMode = false, overrideValues = true }) {
      const {
        tokens: tokens2,
        collection: collection2,
        modeId,
        type: type2
      } = yield getCollectionAndPrepareTokens({ collectionName, modeName, modeIndex, data, sortFn, isSingleMode });
  ...
  function importEffectTokens(params) {
    return __async(this, null, function* () {
      ...
      yield importEffectStyles(tokens2);
    });
  }
  function importTypographyTokens(params) {
    return __async(this, null, function* () {
      ...
      yield importTextStyles(tokens2);
    });
  }
  function processToken(_0) {
    return __async(this, arguments, function* ({
      ...
      if (token.$value !== void 0) {
        if (type2 === "color") {
          return yield setFigmaVariable(
            collection2,
            modeId,
            "COLOR",
            variableName,
            yield getColorTokenValue(token, modeId),
            token.scopes || ["ALL_SCOPES"],
            token.description || null
          );
        }
        if (type2 === "number") {
          let resolvedValue = yield resolveAliasOrValue(valueString, getGlobalTokensDictionary());
        ...
        if (type2 === "string") {
          return yield setFigmaVariable(
            ...
            "STRING",
            variableName,
            yield resolveAliasOrValue(valueString, getGlobalTokensDictionary()),
            token.scopes,
            token.description || null
          ).catch(function(err) {
  ...
  function getColorVariableAliasValue(tokenValue, variableId, modeId) {
    return __async(this, null, function* () {
      ...
      const defaultValueRGBA = yield getDefaultVariableValue(figmaVariable, modeId);
  ...
  function getColorTokenValue(token, modeId) {
    return __async(this, null, function* () {
      ...
      const variableAlias = yield findVariableAlias(valueString);
  ...
  function upgradeTextPalette(params) {
    return __async(this, null, function* () {
      ...
      for (const tokenName in paletteTextLight) {
        yield setFigmaVariable(collection2, mode2.modeId, "COLOR", tokenName);
      }
      yield importVariables({
        collectionName,
        modeName: "Light Base",
  ...
  function exportToJSON(exportParams, formData) {
    return __async(this, null, function* () {
      ...
      for (const collection2 of collections) {
        const exportedData = yield exportFigmaVariableCollection(collection2, exportParams.jsonColorFormat);
        exportedData.forEach((record) => {
          const tokens2 = record.tokens;
  ...
  function exportBrandVariantToJSON(params, formData) {
    return __async(this, null, function* () {
      ...
      for (const collection2 of collections) {
        const exportedCollectionData = yield exportFigmaVariableCollection(collection2, params.brandColorFormat);
  ...
  function getTokenValueFromVariable(value, variable, colorFormat) {
    return __async(this, null, function* () {
      ...
      if (type2 === "VARIABLE_ALIAS") {
        const alias = yield getAliasName(value["id"]);
        return alias;
      }
  ...
  function exportFigmaVariableCollection(collection2, colorFormat = "hsl") {
    return __async(this, null, function* () {
      const collections = [];
  ...
  function exportTextStyles(styles2) {
    return __async(this, null, function* () {
      if (styles2.length == 0) {
        return null;
      }
      ...
      for (const style of styles2) {
        ...
        Object.assign(token, {
          $value: yield convertFigmaTextStyleToToken(style),
          $type: "typography"
        });
      }
      return collection2;
  ...
  function exportEffectStyles(styles2, colorFormat) {
    return __async(this, null, function* () {
      if (styles2.length == 0) {
        return null;
      }
      ...
      for (const style of styles2) {
        ...
        let token = variableNameToObject({ name, targetObject: collection2.tokens });
        Object.assign(token, {
          $value: yield convertFigmaEffectStyleToToken(style, colorFormat),
          $type: "effect",
    ...
    return __async(this, null, function* () {
      ...
      while (data.length) {
        ...
        if (collectionRecord.type == "textStyles") {
          yield importTextStyles(tokensDictionary);
          yield delayAsync(5);
        }
        if (collectionRecord.type == "effectStyles") {
          yield importEffectStyles(flatTokens, tokensDictionary);
          yield delayAsync(5);
        }
      }
    });
  ...
  const handlers = {
    ...
    refreshUI: function(params) {
      return __async(this, null, function* () {
        figma.ui.postMessage({
          type: "REFRESH_UI",
          data: {
            colorSystemVersion: yield getColorSystemVersion(),
    ...
    IMPORT: function(params, message) {
      return __async(this, null, function* () {
        ...
        const colorSystemVersion = yield getColorSystemVersion(true);
        if (colorSystemVersion == 1) {
          yield this.UPGRADE_TEXT_COLORS(params, message);
        }
        yield delayAsync(10);
        yield initiateImport();
        yield importAllTokens();
      });
    },
    GET_EXPORT_DATA: function(params, message) {
      return __async(this, null, function* () {
        figma.ui.postMessage({ type: "EXPORT_RESULT_PRESET", exportRecords: serialize$1() });
        yield exportToJSON(message.exportJSONParams).then((exportRecords) => {
          figma.ui.postMessage({ type: "EXPORT_RESULT_JSON", exportRecords });
        });
        yield exportBrandVariantToJSON(message.exportBrandParams, params).then((exportRecords) => {
    ...
    IMPORT_JSON: function(params, message) {
      return __async(this, null, function* () {
        ...
        yield importFromJSON(message.data).catch((error) => {
          console.error(error);
          figma.ui.postMessage("IMPORT_COMPLETED");
    ...
    UPGRADE_TEXT_COLORS: function(params, message) {
      return __async(this, null, function* () {
        yield upgradeTextPalette(params);
    ...
    CREATE_ELEVATION_COMPONENTS: function(params, message) {
      return __async(this, null, function* () {
        ...
        yield createUpdateElevationComponents(params, page).catch((error) => {
          figma.notify(error.message, { error: true });
        });
      });
    },
    ...
    RESET: function(params, message) {
      return __async(this, null, function* () {
        resetDefaults();
        yield this.refreshUI(getTheme("light"));
      });
    },
  ...
  function run() {
    ...
    figma.ui.onmessage = (eventData) => __async(this, null, function* () {
      var _a, _b;
